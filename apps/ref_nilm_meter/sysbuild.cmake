# sysbuild.cmake for ref_nilm_meter
if(NOT SYSBUILD_REF_NILM_METER_INCLUDED)
    set(SYSBUILD_REF_NILM_METER_INCLUDED TRUE)
    ...
    set(ref_nilm_meter_BOARD v32f20x_board/v32f20x/cpuapp/cpuapp_ns CACHE STRING "" FORCE)
    set(ref_nilm_meter_BOARD_ROOT /workspaces/modules/soc/v32f20x CACHE STRING "" FORCE)
    set(ref_nilm_meter_CONF_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/prj.conf CACHE STRING "" FORCE)
    set(ref_nilm_meter_DTC_OVERLAY_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/app.overlay CACHE STRING "" FORCE)
    ...
    sysbuild_add_dependencies(CONFIGURE ref_nilm_meter cpumeter)
endif()
