# sysbuild.cmake for ref_motor_pred_maint
if(NOT SYSBUILD_REF_MOTOR_PRED_MAINT_INCLUDED)
    set(SYSBUILD_REF_MOTOR_PRED_MAINT_INCLUDED TRUE)
    ...
    set(ref_motor_pred_maint_BOARD v32f20x_board/v32f20x/cpuapp/cpuapp_ns CACHE STRING "" FORCE)
    set(ref_motor_pred_maint_BOARD_ROOT /workspaces/modules/soc/v32f20x CACHE STRING "" FORCE)
    set(ref_motor_pred_maint_CONF_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/prj.conf CACHE STRING "" FORCE)
    set(ref_motor_pred_maint_DTC_OVERLAY_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/app.overlay CACHE STRING "" FORCE)
    ...
    sysbuild_add_dependencies(CONFIGURE ref_motor_pred_maint cpumeter)
endif()
