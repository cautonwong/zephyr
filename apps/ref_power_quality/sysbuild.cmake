# sysbuild.cmake for ref_power_quality
if(NOT SYSBUILD_REF_POWER_QUALITY_INCLUDED)
    set(SYSBUILD_REF_POWER_QUALITY_INCLUDED TRUE)
    ...
    set(ref_power_quality_BOARD v32f20x_board/v32f20x/cpuapp/cpuapp_ns CACHE STRING "" FORCE)
    set(ref_power_quality_BOARD_ROOT /workspaces/modules/soc/v32f20x CACHE STRING "" FORCE)
    set(ref_power_quality_CONF_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/prj.conf CACHE STRING "" FORCE)
    set(ref_power_quality_DTC_OVERLAY_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/app.overlay CACHE STRING "" FORCE)
    ...
    sysbuild_add_dependencies(CONFIGURE ref_power_quality cpumeter)
endif()
