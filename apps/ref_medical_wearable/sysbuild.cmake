# sysbuild.cmake for ref_medical_wearable
if(NOT SYSBUILD_REF_MEDICAL_WEARABLE_INCLUDED)
    set(SYSBUILD_REF_MEDICAL_WEARABLE_INCLUDED TRUE)
    ...
    set(ref_medical_wearable_BOARD v32f20x_board/v32f20x/cpuapp/cpuapp_ns CACHE STRING "" FORCE)
    set(ref_medical_wearable_BOARD_ROOT /workspaces/modules/soc/v32f20x CACHE STRING "" FORCE)
    set(ref_medical_wearable_CONF_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/prj.conf CACHE STRING "" FORCE)
    set(ref_medical_wearable_DTC_OVERLAY_FILE ${APP_DIR}/targets/v32_cpuapp_gateway_ns/app.overlay CACHE STRING "" FORCE)
    ...
    sysbuild_add_dependencies(CONFIGURE ref_medical_wearable cpumeter)
endif()
